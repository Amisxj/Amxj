		...
		<div class="left">
			<div class="menu">
				<div class="menu_title">
					企业简介 <br> <span>Company profiles</span>
				</div>
				<ul id="tab">
					<li class="active" onclick="changeValue(this)"><a
						href="javascript:void(0)">企业概况</a></li>
					<li onclick="changeValue(this)"><a href="javascript:void(0)">企业认证</a>
					</li>
			...
			<div style="font-size: 14px; margin-top: 53px; line-height: 36px;">
				<div id="tab_con">
					<div id="tab_con_1" class="active">
						...
						<p>创立时间</p>
						<br>
						<p>吉林省明日科技有限公司（工商注册）创建成立于 1999 年 12 月</p>
						...
						<br>
						<p>经过不断创新，明日科技成功开发出独具特色的创新型产品和行业知名品牌，形成企业四大系列支柱产品：</p>
						<br>
						<p>1、编程词典系列软件。近百位专家历时六年研发成功的全国首款数字化学习编程的教育软件。</p>
						<br>
						<p>2、IT词典系列软件。包含电脑知识入门、硬件维护、办公软件操作和图形图像在内的系列词典软件。</p>
						<br>
						<p>
							3、行业管理软件。专注于开发煤矿专业领域的信息化系统，开发了煤矿电话智能综合管理系统、瓦斯通风管理系统、基于图形拨测系统等10多种专业软件，应用于多家企业。
						</p>
						<br>
						<p>4、专业开发类编程图书。目前已出版专业开发类编程图书近300本，已成为国内最畅销的编程图书品牌。</p>
						<br>
						<p>目前，明日科技的用户人群已经超过1000万，伴随着国家数字化产业的飞速发展，依托庞大的用户资源，明日科技坚持
