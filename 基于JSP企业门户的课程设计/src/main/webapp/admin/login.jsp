...
<%@page import="com.mingrisoft.user.Login"%>
<%@page import="com.mingrisoft.utils.Utils"%>
<%@page import="com.wf.captcha.ArithmeticCaptcha"%>
<!DOCTYPE html>
<html>
<head lang="en">
<meta charset="UTF-8">
		...
		<div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
			<form action="login.jsp" method="post" class="am-form login-form"
				...
				<div class="am-cf">
					...
					<!-- 用于登录提交按钮 -->
					<input type="submit" value="登 录" id="save"
						class="am-btn am-btn-primary am-btn-sm am-fl">
				</div>
				<div style="border=1px solid red;">
				<br>
				输入验证码：<input id="number" name="number">
				<%
							ArithmeticCaptcha athc = new ArithmeticCaptcha(200, 100);
							athc.setLen(2);
							String value = athc.text();
							String img = athc.toBase64();
							System.out.print(img);
							out.println("<img src='"+img+"' style='border:1px solid black;'");	
